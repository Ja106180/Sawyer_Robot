...
(cl:defclass <ObjectDetections> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (objects
    :reader objects
    :initarg :objects
    :type (cl:vector my_car_yolo-msg:ObjectDetection)
   :initform (cl:make-array 0 :element-type 'my_car_yolo-msg:ObjectDetection :initial-element (cl:make-instance 'my_car_yolo-msg:ObjectDetection))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectDetections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectDetections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_car_yolo-msg:<ObjectDetections> is deprecated: use my_car_yolo-msg:ObjectDetections instead.")))
...
(cl:defmethod objects-val ((m <ObjectDetections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_car_yolo-msg:objects-val is deprecated.  Use my_car_yolo-msg:objects instead.")
  (objects m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectDetections>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'objects)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'my_car_yolo-msg:ObjectDetection))
