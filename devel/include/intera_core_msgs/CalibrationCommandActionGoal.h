...
bool operator==(const ::intera_core_msgs::CalibrationCommandActionGoal_<ContainerAllocator1> & lhs, const ::intera_core_msgs::CalibrationCommandActionGoal_<ContainerAllocator2> & rhs)
{
