...
struct Printer< ::intera_core_msgs::SEAJointState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::SEAJointState_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "commanded_position: ";
    if (v.commanded_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.commanded_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.commanded_position[i]);
    }
    if (v.commanded_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (v.commanded_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.commanded_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.commanded_velocity[i]);
    }
    if (v.commanded_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "commanded_acceleration: ";
    if (v.commanded_acceleration.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.commanded_acceleration.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.commanded_acceleration[i]);
    }
    if (v.commanded_acceleration.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (v.commanded_effort.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.commanded_effort.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.commanded_effort[i]);
    }
    if (v.commanded_effort.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (v.actual_position.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_position.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_position[i]);
    }
    if (v.actual_position.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (v.actual_velocity.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_velocity.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_velocity[i]);
    }
    if (v.actual_velocity.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "actual_effort: ";
    if (v.actual_effort.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.actual_effort.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.actual_effort[i]);
    }
    if (v.actual_effort.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "gravity_model_effort: ";
    if (v.gravity_model_effort.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.gravity_model_effort.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.gravity_model_effort[i]);
    }
    if (v.gravity_model_effort.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "gravity_only: ";
    if (v.gravity_only.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.gravity_only.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.gravity_only[i]);
    }
    if (v.gravity_only.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "interaction_torque: ";
    if (v.interaction_torque.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.interaction_torque.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.interaction_torque[i]);
    }
    if (v.interaction_torque.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "hysteresis_model_effort: ";
    if (v.hysteresis_model_effort.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.hysteresis_model_effort.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.hysteresis_model_effort[i]);
    }
    if (v.hysteresis_model_effort.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "crosstalk_model_effort: ";
    if (v.crosstalk_model_effort.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.crosstalk_model_effort.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.crosstalk_model_effort[i]);
    }
    if (v.crosstalk_model_effort.empty() || true)
      s << "]";
    if (true || !indent.empty())
