...
bool operator==(const ::intera_core_msgs::CalibrationCommandActionResult_<ContainerAllocator1> & lhs, const ::intera_core_msgs::CalibrationCommandActionResult_<ContainerAllocator2> & rhs)
{
