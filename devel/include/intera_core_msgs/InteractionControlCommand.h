...
struct InteractionControlCommand_
{
  ...
  _K_impedance_type K_impedance;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _max_impedance_type;
  ...
  _D_impedance_type D_impedance;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _K_nullspace_type;
  _K_nullspace_type K_nullspace;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _force_command_type;
  ...
  _disable_reference_resetting_type disable_reference_resetting;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _interaction_control_mode_type;
...
struct Printer< ::intera_core_msgs::InteractionControlCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::InteractionControlCommand_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "K_impedance: ";
    if (v.K_impedance.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.K_impedance.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.K_impedance[i]);
    }
    if (v.K_impedance.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "max_impedance: ";
    if (v.max_impedance.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.max_impedance.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.max_impedance[i]);
    }
    if (v.max_impedance.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "D_impedance: ";
    if (v.D_impedance.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.D_impedance.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.D_impedance[i]);
    }
    if (v.D_impedance.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "K_nullspace: ";
    if (v.K_nullspace.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.K_nullspace.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.K_nullspace[i]);
    }
    if (v.K_nullspace.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "force_command: ";
    if (v.force_command.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.force_command.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.force_command[i]);
    }
    if (v.force_command.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "interaction_control_mode: ";
    if (v.interaction_control_mode.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.interaction_control_mode.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.interaction_control_mode[i]);
    }
    if (v.interaction_control_mode.empty() || true)
      s << "]";
    if (true || !indent.empty())
