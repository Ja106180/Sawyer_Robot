...
bool operator==(const ::intera_core_msgs::NavigatorState_<ContainerAllocator1> & lhs, const ::intera_core_msgs::NavigatorState_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::intera_core_msgs::NavigatorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::NavigatorState_<ContainerAllocator>& v)
  {
    if (false || !indent.empty())
      s << std::endl;
    s << indent << "button_names: ";
    if (v.button_names.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.button_names.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.button_names[i]);
    }
    if (v.button_names.empty() || true)
      s << "]";
    ...
    for (size_t i = 0; i < v.buttons.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.buttons[i]);
    }
    if (v.buttons.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "light_names: ";
    if (v.light_names.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.light_names.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, true ? std::string() : indent + "    ", v.light_names[i]);
    }
    if (v.light_names.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.lights.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.lights[i]);
    }
    if (v.lights.empty() || true)
      s << "]";
  }
