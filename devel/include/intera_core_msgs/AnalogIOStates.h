...
struct AnalogIOStates_
{
  ...
  _names_type names;
   ...
   typedef std::vector< ::intera_core_msgs::AnalogIOState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::intera_core_msgs::AnalogIOState_<ContainerAllocator> >> _states_type;
  _states_type states;
...
bool operator==(const ::intera_core_msgs::AnalogIOStates_<ContainerAllocator1> & lhs, const ::intera_core_msgs::AnalogIOStates_<ContainerAllocator2> & rhs)
{
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::AnalogIOStates_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.states.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::intera_core_msgs::AnalogIOState_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.states[i]);
    }
    if (v.states.empty() || false)
      s << "]";
  }
