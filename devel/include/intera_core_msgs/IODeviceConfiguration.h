...
struct IODeviceConfiguration_
{
  ...
  _time_type time;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _commanded_type;
  _commanded_type commanded;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _upgraded_type;
  _upgraded_type upgraded;

   typedef  ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator>  _device_type;
  _device_type device;

   typedef std::vector< ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator> >> _ports_type;
  _ports_type ports;

   typedef std::vector< ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator> >> _signals_type;
...
struct Printer< ::intera_core_msgs::IODeviceConfiguration_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_core_msgs::IODeviceConfiguration_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "commanded: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.commanded);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "upgraded: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.upgraded);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "device: ";
    ...
    for (size_t i = 0; i < v.ports.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.ports[i]);
    }
    if (v.ports.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    for (size_t i = 0; i < v.signals.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::intera_core_msgs::IOComponentConfiguration_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.signals[i]);
    }
    if (v.signals.empty() || false)
      s << "]";
  }
