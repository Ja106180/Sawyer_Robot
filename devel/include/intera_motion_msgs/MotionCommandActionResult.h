...
bool operator==(const ::intera_motion_msgs::MotionCommandActionResult_<ContainerAllocator1> & lhs, const ::intera_motion_msgs::MotionCommandActionResult_<ContainerAllocator2> & rhs)
{
