...
struct EndpointTrackingError_
{
  ...
  _trajectory_time_type trajectory_time;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _active_endpoint_type;
...
bool operator==(const ::intera_motion_msgs::EndpointTrackingError_<ContainerAllocator1> & lhs, const ::intera_motion_msgs::EndpointTrackingError_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.trajectory_id == rhs.trajectory_id &&
    lhs.trajectory_time == rhs.trajectory_time &&
    lhs.active_endpoint == rhs.active_endpoint &&
    lhs.pose_error == rhs.pose_error &&
    lhs.twist_error == rhs.twist_error &&
    lhs.pose_command == rhs.pose_command &&
    lhs.twist_command == rhs.twist_command;
}
...
struct Printer< ::intera_motion_msgs::EndpointTrackingError_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_motion_msgs::EndpointTrackingError_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.active_endpoint);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "pose_error: ";
