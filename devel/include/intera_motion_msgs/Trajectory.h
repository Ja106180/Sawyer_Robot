...
struct Trajectory_
{
  ...
  _joint_names_type joint_names;
   ...
   typedef std::vector< ::intera_motion_msgs::Waypoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::intera_motion_msgs::Waypoint_<ContainerAllocator> >> _waypoints_type;
...
bool operator==(const ::intera_motion_msgs::Trajectory_<ContainerAllocator1> & lhs, const ::intera_motion_msgs::Trajectory_<ContainerAllocator2> & rhs)
{
  return lhs.label == rhs.label &&
    lhs.joint_names == rhs.joint_names &&
    lhs.waypoints == rhs.waypoints &&
    lhs.trajectory_options == rhs.trajectory_options;
}
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_motion_msgs::Trajectory_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.waypoints.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::intera_motion_msgs::Waypoint_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.waypoints[i]);
    }
    if (v.waypoints.empty() || false)
      s << "]";
    if (true || !indent.empty())
