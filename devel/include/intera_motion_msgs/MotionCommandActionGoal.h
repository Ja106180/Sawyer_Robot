...
bool operator==(const ::intera_motion_msgs::MotionCommandActionGoal_<ContainerAllocator1> & lhs, const ::intera_motion_msgs::MotionCommandActionGoal_<ContainerAllocator2> & rhs)
{
