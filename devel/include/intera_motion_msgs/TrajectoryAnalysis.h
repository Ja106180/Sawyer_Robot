...
struct TrajectoryAnalysis_
{
  ...
  _measured_duration_type measured_duration;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _min_angle_command_type;
  _min_angle_command_type min_angle_command;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _max_angle_command_type;
  _max_angle_command_type max_angle_command;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _peak_speed_command_type;
  _peak_speed_command_type peak_speed_command;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _peak_accel_command_type;
  _peak_accel_command_type peak_accel_command;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _peak_jerk_command_type;
  ...
  _max_time_rate_type max_time_rate;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _max_position_error_type;
  _max_position_error_type max_position_error;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _max_velocity_error_type;
...
bool operator==(const ::intera_motion_msgs::TrajectoryAnalysis_<ContainerAllocator1> & lhs, const ::intera_motion_msgs::TrajectoryAnalysis_<ContainerAllocator2> & rhs)
{
  return lhs.planned_duration == rhs.planned_duration &&
    lhs.measured_duration == rhs.measured_duration &&
    lhs.min_angle_command == rhs.min_angle_command &&
    lhs.max_angle_command == rhs.max_angle_command &&
    lhs.peak_speed_command == rhs.peak_speed_command &&
    lhs.peak_accel_command == rhs.peak_accel_command &&
    lhs.peak_jerk_command == rhs.peak_jerk_command &&
    lhs.min_time_rate == rhs.min_time_rate &&
    lhs.max_time_rate == rhs.max_time_rate &&
    lhs.max_position_error == rhs.max_position_error &&
...
struct Printer< ::intera_motion_msgs::TrajectoryAnalysis_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::intera_motion_msgs::TrajectoryAnalysis_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "min_angle_command: ";
    if (v.min_angle_command.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.min_angle_command.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.min_angle_command[i]);
    }
    if (v.min_angle_command.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "max_angle_command: ";
    if (v.max_angle_command.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.max_angle_command.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.max_angle_command[i]);
    }
    if (v.max_angle_command.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "peak_speed_command: ";
    if (v.peak_speed_command.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.peak_speed_command.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.peak_speed_command[i]);
    }
    if (v.peak_speed_command.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "peak_accel_command: ";
    if (v.peak_accel_command.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.peak_accel_command.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.peak_accel_command[i]);
    }
    if (v.peak_accel_command.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "peak_jerk_command: ";
    if (v.peak_jerk_command.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.peak_jerk_command.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.peak_jerk_command[i]);
    }
    if (v.peak_jerk_command.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "max_position_error: ";
    if (v.max_position_error.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.max_position_error.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.max_position_error[i]);
    }
    if (v.max_position_error.empty() || true)
      s << "]";
    if (true || !indent.empty())
    ...
    if (v.max_velocity_error.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.max_velocity_error.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<double>::stream(s, true ? std::string() : indent + "    ", v.max_velocity_error[i]);
    }
    if (v.max_velocity_error.empty() || true)
      s << "]";
  }
