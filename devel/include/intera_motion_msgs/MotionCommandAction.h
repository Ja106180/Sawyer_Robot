...
bool operator==(const ::intera_motion_msgs::MotionCommandAction_<ContainerAllocator1> & lhs, const ::intera_motion_msgs::MotionCommandAction_<ContainerAllocator2> & rhs)
{
