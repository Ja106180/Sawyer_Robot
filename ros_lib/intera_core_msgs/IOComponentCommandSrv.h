...
static const char IOCOMPONENTCOMMANDSRV[] = "intera_core_msgs/IOComponentCommandSrv";
  ...
  class IOComponentCommandSrvRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return IOCOMPONENTCOMMANDSRV; };
    virtual const char * getMD5() override { return "f1576f0935f7d90abe14dbedf574be71"; };
  ...
  class IOComponentCommandSrvResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return IOCOMPONENTCOMMANDSRV; };
    virtual const char * getMD5() override { return "201c021e76b3e871e24d4b9fd38ffd49"; };
