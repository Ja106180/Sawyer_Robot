...
window.onload = function () {
    ...
    var transferGraspSrv = new ROSLIB.Service({ ros: ros, name: '/sawyer_transfer_grasp', serviceType: 'std_srvs/SetBool' });
    ...
    bindMode('btn-transfer-grasp', transferGraspSrv, "Transfer Grasping");
